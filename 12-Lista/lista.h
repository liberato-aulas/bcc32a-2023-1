...
/**
 * @brief Desaloca todos os espaços alocados dinamicamente ocupados pela lista 
 *        e limpa o lixo de memória
 *
 * @param endLista: Endereço de memória onde está o ponteiro da lista a ser desalocada
 */
...
/**
 * @brief Devolve uma versão da lista no formato de string. O formato utilizado deve ser: 
 *        [elem1,elem2,...,elemn]
 *
 * @param l: endereço da lista
...
/**
 * @brief Imprime a lista no console.
 *
 * @param l: endereço da lista
 */
